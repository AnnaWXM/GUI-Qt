...
QT_MOC_LITERAL(3, 16, 10), // "date_value"
QT_MOC_LITERAL(4, 27, 13) // "func_set_date"

    },
    "myApp\0sendMess\0\0date_value\0func_set_date"
};
...
void myApp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->func_set_date(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (myApp::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myApp::sendMess)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void myApp::sendMess(const QString & _t1)
{
