...
QT_MOC_LITERAL(1, 6, 8), // "sendMess"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 11), // "gauge_value"
QT_MOC_LITERAL(4, 28, 14), // "func_set_value"
QT_MOC_LITERAL(5, 43, 10) // "slider_val"

    },
    "gauge\0sendMess\0\0gauge_value\0func_set_value\0"
    "slider_val"
};
...
void gauge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendMess((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->func_set_value((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (gauge::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&gauge::sendMess)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void gauge::sendMess(const QString & _t1)
{
